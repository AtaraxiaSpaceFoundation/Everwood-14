...
chat-radio-message-wrap-bold = [color={$color}]{$channel} {$name} {$verb}, [font="{$fontType}" size={$fontSize}][Tannenberg]"[/color][color={$languageColor}]{$message}[/color][color={$color}]"[/Tannenberg][/font][/color]

...
cargo-console-unlock-approved-order-broadcast = [Tannenberg]{$productName} x{$orderAmount}[/Tannenberg], which cost [Tannenberg]{$cost}[/Tannenberg], was approved by [Tannenberg]{$approverName}, {$approverJob}[/Tannenberg]
